package com.darrenfinch.mymealplanner.addeditmeal.controller
...
import com.darrenfinch.mymealplanner.selectfoodformeal.controller.SelectFoodForMealDialog
...
class AddEditMealFragment : Fragment() {
    ...
    private fun openSelectFoodForMealFragment() {
        val selectFoodForMealDialog =
            SelectFoodForMealDialog()
