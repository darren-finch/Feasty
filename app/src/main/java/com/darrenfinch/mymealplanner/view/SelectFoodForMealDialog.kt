...
import com.darrenfinch.mymealplanner.viewmodels.SelectFoodForMealViewModel
...
class SelectFoodForMealDialog : DialogFragment() {
    ...
    private val foodsListAdapter = FoodsRecyclerViewAdapter(FoodsRecyclerViewAdapter.Config(false), mutableListOf()).apply { setOnItemEventListener(foodsListItemEventListener) }
